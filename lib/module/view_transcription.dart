        ...
        actions: selectedIds.isNotEmpty
            ? [
                TextButton(
                  onPressed: () {
                    setState(() {
                      selectedIds = transcriptions.map((e) => e['id'] as String).toSet();
                    });
                  },
        ...
        :  ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Dismissible(
                ...
                child: Card(
                  color: isSelected ? Colors.red[200] : Colors.red[100],
                  margin: const EdgeInsets.symmetric(vertical: 8.0),
                  child: ListTile(
                    onLongPress: () => handleLongPress(id),
                    onTap: () => handleTap(id, index),
                    title: Text(
                      item['isDecrypted']
                    ...
                    trailing: selectedIds.isEmpty
                        ? ElevatedButton(
                            ...
                            child: Text(item['isDecrypted'] ? 'Hide' : 'View'),
                          )
                        : Checkbox(
                            value: isSelected,
      ...
      bottomNavigationBar: selectedIds.isNotEmpty
          ? BottomNavigationBar(
              items: const [
                ...
                BottomNavigationBarItem(icon: Icon(Icons.edit), label: 'Rename'),
